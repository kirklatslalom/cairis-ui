...
<script>
  ...
  export default {
    ...
    computed : {
      narrative() {
        return this.panelObject != undefined ? this.panelObject.theEnvironmentProperties.filter(env => env.theEnvironmentName == this.panelParameters.environment)[0].theNarrative : "";
      }
    }
  };
</script>
