  ...
  <b-navbar toggleable="md" type="dark" variant="dark">
    ...
    <b-navbar-nav>
      ...
      <b-nav-item-dropdown text="System">
        ...
        <b-dropdown-item :to="{name: 'fromtrello'}">Import from Trello</b-dropdown-item>
        <b-dropdown-item :to="{name: 'export'}">Export</b-dropdown-item>
        <b-dropdown-item :to="{name: 'totrello'}">Export to Trello</b-dropdown-item>
      ...
      <b-nav-item-dropdown text="Models">
        ...
        <b-dropdown-item :to="{name: 'controlstructure'}">Control Structure</b-dropdown-item>
    ...
    <b-navbar-nav class="ml-auto">
      ...
      <b-nav-item-dropdown :text="accountName">
