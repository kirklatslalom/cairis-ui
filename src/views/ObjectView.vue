...
export default {
  ...
  computed : {
    bcItems() {
      return this.objt != undefined ? [{text: 'Home', to: {name: 'home'}},{text: this.objectsLabel, to: {name: 'objectsview',params: {dimension: this.dimension}}},{text: this.dimension == 'user_goal' ? this.objt.theSynopsis : this.objt.theName, to : {name: 'objectview', params: {dimension: this.dimension, objectName: this.objectName}}}] : [];
    },
    componentLoader() {
